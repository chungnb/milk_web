<x-app-layout>
    <section class="content">
        <div class="container mx-auto p-6">
            ...
            <form action="{{ route('admin.slide_img.update', $slide->id) }}" method="POST" enctype="multipart/form-data"
                class="space-y-4">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="file" name="image" id="image" value="{{ old('image', $slide->image) }}"
