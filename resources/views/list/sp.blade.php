    ...
    <div class="elementor-container elementor-column-gap-no">
        <div class="elementor-widget-container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <h1 style="padding: 6% 6% 6% 6%;background-color: #29bcc4;margin-top: 12px; text-align:center;"
                        class="elementor-heading-title elementor-size-medium 1111"><a
                            style="color:#fff;font-size: 20px;" href="">{{ $category->name }}</a>
                    </h1>
                    @if($category->image)
                    <img style="width:400px;" src="{{ asset('storage/' . $category->image) }}"
